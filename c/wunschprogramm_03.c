...
int iSchreibenTxt()                      /*Funktion zum Schreiben der Txt File*/
{
     ...
     printf("\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4");
     printf("\xC4\xC4\xC4\xC4\xC4\xC4\xC4\n");
	 printf("\t\t\t     Wieviel Wuensche anlegen? ");
	 fflush(stdin);
	 scanf("%i", &iAnzahl); 
     ...
     printf("\t\t* Es duerfen nur %3i iAnzahl eingegeben werden\t*\n",iAnzahl);                                           
...
int iFortsetzenTxt()                     /*Funktion zum anhaengen der Txt File*/
{
     ...
     printf("\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4");
     printf("\xC4\xC4\xC4\xC4\xC4\xC4\xC4\n");
	 printf("\t\t\t     Wieviel Wuensche fortsetzen? ");
	 fflush(stdin);
	 scanf("%i", &iAnzahl); 
...
/** Funtkion : Wunschtext Schreiben Binaerformat
  * Status   : in Abreit
  *            in Planung Funktion Abbrechen mit Taste Esc
  */
int iSchreibenBin()                      
	  ...
	  scanf("%i", &iAnzahl); 
          ...
          { 
             ...
             do
             {
                for(iZaehler = 1; iZaehler <= iAnzahl; iZaehler++)
                {
                    printf("\t\t %3i.Wunsch: %s",iZaehler, sZeichen);  /*Ausgabe Inhalt .bin*/   
                    fgets(sZeichen,LAENGE,FPWunsch);
                }
             }while(!feof(FPWunsch));
