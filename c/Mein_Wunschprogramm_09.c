/** Programmname : wunschprogramm.c
  ...
  *				   Funktionen Entfernen und Umbennen verbessern
...
/** Funktion : BIN Datei loeschen
  ...
  */
  int iEntfernen()
  {
      ...
      printf("\n\t\t   M\x94 \bchten Sie Ihre W\x81nsche l\x94schen?");
      getch();
	  if(FPWunsch != NULL)
      {
...
/** Funktion : BIN Datei umbenennen 
  ...
  */
  int iUmbenennen()
  {
      ...
      printf("\n\t\t   M\x94 \bchten Sie eine Sicherungskopie anlegen?");
      getch();
      rename(DATEI, BACKUP);
      return 0;
  }
  ...
  int iMenue()
  {
    ...
    do
	{
	  ...
	  switch(iEingabe = getch() )
      {
         ...
         case '2':
         {
	            printf("\t\t\t     Benutzer wird abgemeldet\t");
                sleep(1000); 
  ...
  {    
	...
	do
	{
	  ...
	  {                                
         ...
         case '4':
         { 
    	  	    printf("\t\t\t     Meine W\x81nsche Sichern\t");
                sleep(1000);
                iUmbenennen();                    /*Eingabeauswahl Bin aendern*/
                break;
         }
         case '5':
         { 
