  ...
  */
  int iRechnen()
  {
    ...
    printf("\n\t\t\tBitte Zahlen eingeben: ");
	  ...
	  iSum = iZahlen[0]; /* iErgebnis mit Werten von iZahlen fÃ¼llen */
	  for( x = 1; x < i; x++ )
	  {
		  iSum += iZahlen[x];
		  if( x == 1)
	  ...
	  iDiff = iZahlen[0]; /* iErgebnis mit Werten von iZahlen fÃ¼llen */
	  for( x = 1; x < i; x++ )
	  {
		  iDiff -= iZahlen[x];
		  if( x == 1)
      ...
      iPro = iZahlen[0]; /* iErgebnis mit Werten von iZahlen fÃ¼llen */
	  for( x = 1; x < i; x++ )
	  {
		  iPro *= iZahlen[x];
		  if( x == 1)
	  ...
	  iQuo = iZahlen[0]; /* iErgebnis mit Werten von iZahlen fÃ¼llen */
	  for( x = 1; x < i; x++ )
	  {
		  iQuo /= iZahlen[x];
		  if( x == 1)
