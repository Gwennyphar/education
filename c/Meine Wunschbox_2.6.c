      ...
      if( iJa_Nein() )
      {
       ...
       /* ... aber wenn Originaldatei nicht vorhanden, breche hier ab */
          if( (rename( DATEI, sBackup)) != 0 )
          {
              ...
              sleep(1000);
      	   	  printf("\t\t\t     Es sind noch keine W\x81nsche verfasst!");
              sleep(1000);
              printf("\n\t\t   M\x94 \bchten Sie Ihre W\x81nsche verfassen? Ja/Nein");
   	   	      if( iJa_Nein() )
  ...
  */
  int iEntfernen()
  {
      ...
      if( iJa_Nein() )                            /* wenn ja dann gehe weiter */
      {
          ...
          printf("\t\t   Welche Datei m\x94 \bchten Sie l\x94schen? ");
          fflush(stdin);
          scanf("%s", sPfad);               /* hier wird die Datei eingelesen */
