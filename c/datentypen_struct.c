  ...
  */
  ...
  int iAdressen()
  {
      ...
      for( iZaehler = 1; iZaehler <= iDurchlauf; iZaehler++ )
      {
           ...
           printf("\n\tVorname     : ");
           fflush(stdin);
           fgets(stAdressen[iFeld].sVorname, 15, stdin);
           printf("\tNachname    : ");
           fflush(stdin);
           fgets(stAdressen[iFeld].sNachname, 15, stdin);
           printf("\tStrasse     : ");
           fflush(stdin);
           fgets(stAdressen[iFeld].sStrasse, 15, stdin);
           printf("\tPostleitzahl: ");
           fflush(stdin);
           fgets(stAdressen[iFeld].sPLZ, 6, stdin);
           printf("\tWohnort     : ");
           fflush(stdin);
           fgets(stAdressen[iFeld].sOrt, 15, stdin);      
      }
      for( iZaehler = 1; iZaehler <= iDurchlauf; iZaehler++ )
      {
           printf("\n\tIhre %i.erfasste Adresse!", iZaehler);
           printf("\n\t_____________________________\n");
           printf("\tVorname     : %s\n", stAdressen[10].sVorname);
           printf("\tNachname    : %s\n", stAdressen[10].sNachname);
           printf("\tStrasse     : %s\n", stAdressen[10].sStrasse);
      ...
      for( iZaehler = 1; iZaehler <= iDurchlauf; iZaehler++ )
      {
           ...
           fprintf(FPZeiger_schreiben,  "\n\t_____________________________\n");
           iGroesse = sizeof(stAdressen);
           fwrite(stAdressen, sizeof iGroesse, 1, FPZeiger_schreiben);
      }
