...
void Avatar()
{
	do
	{
		...
		printf("\n\n     Möchten Sie ihren Avatar wechseln?\n");
...
void Trainieren()
{
	...
	flush();
	if(Tamagotchi.runden <= 0.00 || Tamagotchi.Koerpergewicht <= 200.00)
	{
	}
	else 
	{
...
void Hygiene()
{
	...
	flush();
	if(Tamagotchi.reinigen <= 0.00 || Tamagotchi.Happyness >= 25.00)
	{
	}
	else
	{
